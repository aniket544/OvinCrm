...
//       boxShadow: "0 0 20px rgba(255, 187, 51, 0.5)",
//       color: "#fff",
//       width: "350px",
//     },
//     header: {
...
//       <h3
//         style={{ color: "#00ffcc", textAlign: "center", marginBottom: "15px" }}
//       >
//         📞 Follow-up Task: {lead.company}
//       </h3>
...
//     <div style={styles.modal}>
//       <h3
//         style={{ color: "#00ffcc", textAlign: "center", marginBottom: "20px" }}
//       >
//         💰 Finalize Deal: {lead.company}
//       </h3>
//       <div style={styles.row}>
//         <div style={styles.col}>
//           <label style={styles.label}>Sales Order No.</label>
//           <input
//             type="text"
//             name="so_no"
//             value={paymentData.so_no}
...
//             type="text"
//             readOnly
//             value={`₹ ${paymentData.remaining}`}
//             style={{ ...styles.input, color: "#ffbb33", fontWeight: "bold" }}
//           />
//         </div>
//       </div>
...
//         `Cleaning & Processing ${data.length} leads...`
//       );
...
//         let company = String(rawCompany || "Unknown")
//           .trim()
//           .substring(0, 190);
//         if (!company || company.toLowerCase() === "unknown")
//           company = "Unknown Company";

//         let name = String(rawName || "Unknown")
//           .trim()
//           .substring(0, 90);
...
//         const finalNote = rawRemark
//           ? `${importNote}: ${rawRemark}`
//           : importNote;
...
//       try {
//         toast.loading(`Uploading ${bulkPayload.length} leads...`, {
//           id: toastId,
//         });
...
//             const errIndex = error.response.data.findIndex(
//               (e) => Object.keys(e).length > 0
//             );
//             if (errIndex !== -1) {
//               const errDetail = error.response.data[errIndex];
//               errMsg = `Row ${errIndex + 1} Error: ${JSON.stringify(
//                 errDetail
//               )}`;
//             }
//           } else {
...
//       await axios.patch(
//         `${LEAD_API_URL}${lead.id}/`,
//         { status: "Interested" },
//         headers
//       );
//       setLeads(
//         leads.map((l) =>
//           l.id === lead.id ? { ...l, status: "Interested" } : l
//         )
//       );
...
//                 </>
//               ) : (
//                 <button style={styles.btnPrimary} onClick={handleSaveOrUpdate}>
//                   + Save
//                 </button>
//               )}
...
//                 onChange={handleFileChange}
//               />
//               <button style={styles.btnImport} onClick={handleImportClick}>
//                 📥 Import
//               </button>
//             </>
//           )}
...
//                     </td>
//                   )}
//                   <td style={{ ...styles.td, fontSize: "12px", color: "#bbb" }}>
//                     {formatDateTime(l.date)}
//                   </td>
//                   <td style={styles.td}>
//                     {l.sno || (currentPage - 1) * 20 + index + 1}
//                   </td>{" "}
//                   <td
...
//                   <td style={{ ...styles.td, color: "#00ffcc" }}>
//                     {l.contact}
//                   </td>
...
//                         fontSize: "11px",
//                         background:
//                           l.status === "Converted" ? "#28a745" : "#007bff",
//                         color: "#fff",
//                       }}
//                     >
//                       {l.status}
...
//                             onClick={() => handleMoveToSalesTrigger(l)}
//                             title="Send to Sales"
//                           >
//                             Follow Up 📞
//                           </button>
...
//                               onClick={() => handleConvertTrigger(l)}
//                               title="Convert"
//                             >
//                               Convert 💰
//                             </button>
...
//                             onClick={() => handleDeleteTrigger(l.id)}
//                           >
//                             Del
//                           </button>
//                         </>
